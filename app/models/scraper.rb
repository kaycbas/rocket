...
class Scraper
    ...
    def initialize
        ...
        full_url = 'http://www.paulgraham.com/tablets.html'
        ...
        article[:author] = 'Marc Andreesen'
        article[:description] = "Every Western institution was unprepared for the coronavirus pandemic, despite many prior warnings."
